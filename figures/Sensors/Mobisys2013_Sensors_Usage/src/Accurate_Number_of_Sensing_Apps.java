...
public class Accurate_Number_of_Sensing_Apps
{
	public static void main(String args[])
	{
		...
		try {
			...
			fstream_twenty = new FileInputStream("/home/sonali/Desktop/topTwentyPreProcessing.out");
			...
			for(int i=0;i<popular_sorted_acc.size();i++)  
			{
				//System.out.println(popular_sorted_acc.get(i).pkg+":"+popular_sorted_acc.get(i).freq);
			}
			
			//System.out.println("total instances of acc:"+count_acc);	
