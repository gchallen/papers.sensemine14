...
\XXXnote{stevko: revisit the number and/or the description}.
...
\begin{figure*}[th!]
\centering
\includegraphics[width=0.8\textwidth]{./figures/power/opportunistic_charging/max_difference/graph.pdf}
